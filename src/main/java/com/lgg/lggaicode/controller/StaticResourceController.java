...
public class StaticResourceController {
    ...
    public static final String PREVIEW_ROOT_PATH = AppConstant.CODE_OUTPUT_ROOT_DIR;
    /**
     * 获取静态资源,支持目录重定向
    ...
    private String getContentType(String fileName){
        ...
        if (fileName.endsWith(".jpg")) return "image/jpeg;charset=utf-8";
        if (fileName.endsWith(".png")) return "image/png;charset=utf-8";
