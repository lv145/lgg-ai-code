package com.lgg.lggaicode.ai.streamhandler;
...
import com.lgg.lggaicode.ai.message.StreamMessage;
...
import com.lgg.lggaicode.model.enums.StreamMessageTypeEnum;
...
public class JsonMessageStreamHandler {
    ...
    public Flux<String> handle(Flux<String> originFlux,
                               ...
                               long appId, User loginUser,Long parentId) {
        // 收集数据用于生成后端记忆格式
        ...
        return originFlux
                ...
                .doOnComplete(() -> {
                    ...
                    chatHistoryService.addChatMessage(appId, loginUser.getId(), aiResponse,ChatHistoryMessageTypeEnum.AI, parentId);
                    // 异步构建Vue项目
                ...
                .doOnError(error -> {
                    ...
                    chatHistoryService.addChatMessage(appId, loginUser.getId(), errorMessage, ChatHistoryMessageTypeEnum.AI, parentId);
                });
    }
